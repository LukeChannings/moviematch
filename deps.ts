...
export type { Deferred } from "https://deno.land/std@0.96.0/async/deferred.ts";
...
export { ConsoleHandler } from "https://deno.land/std@0.96.0/log/handlers.ts";
...
export { acceptWebSocket } from "https://deno.land/std@0.96.0/ws/mod.ts";
export {
  extname,
  join as joinPath,
  resolve as resolvePath,
} from "https://deno.land/std@0.96.0/path/posix.ts";
export {
  parse as parseYaml,
  stringify as stringifyYaml,
} from "https://deno.land/std@0.96.0/encoding/yaml.ts";
...
export { readerFromStreamReader } from "https://deno.land/std@0.96.0/io/streams.ts";
export { walk } from "https://deno.land/std@0.96.0/fs/walk.ts";
